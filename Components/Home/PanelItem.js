    ...
    <View style={style.container}>
        ...
        >
            ...
            <View style={style.info}>
              ...
              <Text style={style.text}>Status: {order_status}</Text>
              <Text style={style.text}>Total Amount : {order_total_price}</Text>
              <Text style={style.text}>placed at: {order_placed_at}</Text>
              </TouchableOpacity>
              </View>
