...
const FoodDetails = () => {
   ...
   const {foodId, food_name,food_description,food_image,food_price} = route.params;
   useLayoutEffect(() => {
    navigation.setOptions({
      headerTitle:{product_category},
      headerLeft: () => (
        <HeaderBackButton 
          tintColor='white'
            ...
            <View style={{backgroundColor:'white'}}>
              ...
              <View style={style.pdetails}>
                <View style ={style.pdet}>
                  <View>
                    <Text style={style.text1}> {food_name}</Text>
                    <Text style ={style.pdes}> {food_description}</Text>
                  </View>
                    ...
                    <Text style={style.p}>ksh {food_price}</Text>
                    </View>
